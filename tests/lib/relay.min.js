...
function expect(a){a=new Expect({id:__relay_next_id__(),parent:__relay_stack_peek__(),value:a,caller:__relay_caller__()});__relay_stack_peek__().expects.push(a);return a}function addRelayListener(a){relay().listeners.push(a)}function xdescribe(){}function xbeforeEach(){}function xafterEach(){}function xit(){}function xruns(){}function __relay_extend__(a,b){function c(){}c.prototype=a.prototype;b.prototype=new c;b.prototype.constructor=b}
function __relay_stack_peek__(){var a=relay();return a.relayStack[a.relayStack.length-1]}function __relay_next_id__(){return relay().idCounter++}function __relay_enter__(a,b){__relay_broadcast__("onEnter",a);relay().relayStack.push(a);a.perform(function(){__relay_exit__(b)})}function __relay_exit__(a){var b=relay().relayStack.pop();__relay_broadcast__("onExit",b);a()}function __relay_loop__(a,b,c,e){if(a<b)c(a,function(){__relay_loop__(a+1,b,c,e)});else return e()}
